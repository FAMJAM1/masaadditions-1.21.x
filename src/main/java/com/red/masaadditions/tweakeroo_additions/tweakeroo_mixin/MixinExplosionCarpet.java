...
public class MixinExplosionCarpet {
    ...
    @Redirect(method = "doExplosionB",
            ...
            at = @At(value = "FIELD",
                    target = "Lnet/minecraft/core/particles/ParticleTypes;EXPLOSION_EMITTER:Lnet/minecraft/particle/DefaultParticleType;" , remap = true))
    private static SimpleParticleType redirectSpawnParticles() {
